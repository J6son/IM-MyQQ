...
public:
    ...
    void setupUi(QWidget *UserItem)
    {
        ...
        UserItem->resize(300, 60);
        UserItem->setMinimumSize(QSize(300, 60));
        UserItem->setMaximumSize(QSize(16777215, 60));
        UserItem->setStyleSheet(QStringLiteral("QWidget:hover{background-color: rgb(214, 214, 214)}"));
        ...
        horizontalLayout->setContentsMargins(10, 0, 0, 10);
        ...
        widget_2->setMinimumSize(QSize(241, 59));
        widget_2->setMaximumSize(QSize(16777215, 59));
        ...
        lb_name->setMinimumSize(QSize(72, 20));
        ...
        lb_feeling->setMinimumSize(QSize(72, 20));
